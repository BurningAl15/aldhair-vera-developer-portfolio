...
const BallModel: React.FC<BallModelProps> = ({ icon }) => {
...
const MobileFallback: React.FC<MobileFallbackProps> = ({ icon, name }) => {
...
const BallCanvas: React.FC<BallCanvasProps> = ({ icon, name }) => {
